...
//
//  Created by Bekzod Rakhmatov on 2021/02/20.
...
open class LinearProgressBar: UIView {
    ...
    @IBInspectable public var barColor: UIColor = UIColor(red: 226/255, green: 188/255, blue: 90/255, alpha: 1)
    /// The color of the base layer of the bar
    @IBInspectable public var trackColor: UIColor = UIColor(red: 226/255, green: 188/255, blue: 90/255, alpha: 1)
//        UIColor.yellow
    /// The thickness of the bar
    @IBInspectable public var barThickness: CGFloat = 15
